...
from altimeter.aws.resource.util import policy_doc_dict_to_sorted_str, deep_sort_dict, deep_sort_list

class TestDeepSortDict(TestCase):
    def test_supported_datatypes(self):
        dct = {"xyz": [1234, 5123, 1.2, "foo", {"z": 1, "a": 2}],
               "qrs": 1234,
               "ijk": "qrst",
        ...
        self.assertEqual(sorted_dict_json,
                         expected_sorted_dict_json)
...
class TestDeepSortList(TestCase):
    def test_supported_datatypes(self):
        ...
        self.assertEqual(sorted_list_json,
                         expected_sorted_list_json)
